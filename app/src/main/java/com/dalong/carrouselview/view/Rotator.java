...
public class Rotator {
	...
	private final float mDeceleration = 120.0f;
	 ...
	 * further and longer, when used with {@link #(int)} or
	 * {@link #}.
	 * 
	 * @param extend
	...
	public void fling(float velocityAngle) {
		...
		mVelocity = velocity;
		mDuration = (int) (1000.0f * Math.sqrt(2.0f * mCoeffVelocity * Math.abs(velocity)
				/ mDeceleration));
